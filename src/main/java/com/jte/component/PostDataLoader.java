package com.jte.component;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.jte.domain.Posts;
import com.jte.repository.PostRepository;
    ...
    public void run(String... args) throws Exception {
        if(postRepository.count() == 0){
            ...
            try (InputStream inputStream = TypeReference.class.getResourceAsStream(POSTS_JSON)) {
                ...
                throw new RuntimeException("Failed to read JSON data from posts json", e);
            }
        }
    }
